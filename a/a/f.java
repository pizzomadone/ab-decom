...
DocumentListener {
    ...
    private f(Window container, e object, Point serializable) {
        super((Frame)container, a.i.c.a("abedDialogCycleDoWhileTitle"), true);
        this.setLocation((Point)serializable);
        this.f = object;
        this.a = a.c.a.a.d(a.i.c.a("dialogButtonOK"));
        this.b = a.c.a.a.d(a.i.c.a("dialogButtonCancel"));
        container = new JTextArea(a.i.c.a("abedDialogCycleDoWhileCondition"));
    ...
    public static boolean a(Window window, e object) {
        Point point = MouseInfo.getPointerInfo().getLocation();
        point.translate(15, 15);
        if (g == null) {
            g = new f(window, (e)object, point);
        }
        window = g;
        g.e = ((h)object).l();
        ((f)window).d = ((f)window).e;
        ((f)window).f = object;
        ...
        ((f)window).c.setText(((f)window).e);
        ((f)window).c.requestFocusInWindow();
