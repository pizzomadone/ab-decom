...
DocumentListener {
    ...
    private i(Window container, l object, Point serializable) {
        super((Frame)container, a.i.c.a("abedDialogSelectionIfTitle"), true);
        this.setLocation((Point)serializable);
        this.f = object;
        this.a = a.c.a.a.d(a.i.c.a("dialogButtonOK"));
        this.b = a.c.a.a.d(a.i.c.a("dialogButtonCancel"));
        container = new JTextArea(a.i.c.a("abedDialogSelectionIfLabel"));
    ...
    public static boolean a(Window window, l object) {
        Point point = MouseInfo.getPointerInfo().getLocation();
        point.translate(15, 15);
        if (g == null) {
            g = new i(window, (l)object, point);
        }
        window = g;
        g.e = ((m)object).l();
        ((i)window).d = ((i)window).e;
        ((i)window).f = object;
        ...
        ((i)window).c.setText(((i)window).e);
        ((i)window).c.requestFocusInWindow();
