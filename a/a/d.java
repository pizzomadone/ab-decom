...
DocumentListener {
    ...
    private d(Window container, a.c.b.d object, Point serializable) {
        super((Frame)container, a.i.c.a("abedDialogCommentTitle"), true);
        this.setLocation((Point)serializable);
        this.f = object;
        this.a = a.c.a.a.d(a.i.c.a("dialogButtonOK"));
        this.b = a.c.a.a.d(a.i.c.a("dialogButtonCancel"));
        container = new JTextArea(a.i.c.a("abedDialogCommentLabel"));
    ...
    public static boolean a(Window window, a.c.b.d object) {
        Point point = MouseInfo.getPointerInfo().getLocation();
        point.translate(15, 15);
        if (g == null) {
            g = new d(window, (a.c.b.d)object, point);
        }
        window = g;
        g.e = ((a.c.b.d)object).b();
        ((d)window).d = ((d)window).e;
        ((d)window).f = object;
        ...
        ((d)window).c.setText(((d)window).e);
        ((d)window).c.requestFocusInWindow();
